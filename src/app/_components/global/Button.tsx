  ...
  if (secondary) {
    return (
      <Link
        href={`${href}`}
        target={target}
        className={clsx("px-6 py-3 bg-secondary-color border-2 border-secondary-color text-white rounded-full", className, "transition-all duration-300 ease-in-out", "hover:bg-transparent hover:text-primary-color")}
      >
        {children}
      </Link>
    );
  ...
  if (primary) {
    return (
      <Link
        href={`${href}`}
        target={target}
        className={clsx("px-6 py-3 bg-primary-color border-2 border-primary-color text-white rounded-full", className, "transition-all duration-300 ease-in-out", "hover:bg-transparent hover:text-primary-color")}
      >
        {children}
      </Link>
    );
  ...
  if (secondary) {
    return (
      <button
        ...
        disabled={isDisabled === true}
        type={type}
        className={clsx("px-6 py-3 bg-transparent border-2 border-primary-color text-primary-color rounded-full", className, "transition-all duration-300 ease-in-out", "hover:bg-primary-color hover:text-white")}
      >
        {children}
      </button>
    );
